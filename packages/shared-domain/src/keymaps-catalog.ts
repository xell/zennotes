...
export const KEYMAP_CATALOG: KeymapCatalogEntry[] = [
  ...
  { id: "global.focusSidebar", group: "global", defaultBinding: "", title: "Focus sidebar" },
  { id: "global.filterSidebar", group: "global", defaultBinding: "", title: "Filter sidebar" },
  { id: "view.isolateFolder", group: "global", defaultBinding: "Shift+Mod+I", title: "Isolate folder in sidebar" },
  { id: "view.isolateUp", group: "global", defaultBinding: "", title: "Isolated mode: go up one level" },
  { id: "view.quicklook", group: "global", defaultBinding: "Alt+Mod+U", title: "Toggle Quicklook" },
  ...
  { id: "global.focusLastPane", group: "global", defaultBinding: "", title: "Focus last focused pane" },
  ...
  { id: "global.togglePaneMaximize", group: "global", defaultBinding: "", title: "Toggle maximize pane" },
  { id: "global.gitStatus", group: "global", defaultBinding: "", title: "Open git status" },
  { id: "global.focusEditor", group: "global", defaultBinding: "", title: "Focus editor" },
  ...
  { id: "vim.paneFocusLast", group: "vim", defaultBinding: "", title: "Pane: focus last" },
  ...
  { id: "vim.goToDefinition", group: "vim", defaultBinding: "g x", title: "Follow link at cursor" },
  { id: "vim.lookUpDefinition", group: "vim", defaultBinding: "g d", title: "Look up word at cursor" },
  { id: "vim.gotoNextLink", group: "vim", defaultBinding: "g ]", title: "Go to next link" },
  { id: "vim.gotoPrevLink", group: "vim", defaultBinding: "g [", title: "Go to previous link" },
  ...
  { id: "nav.collapseAll", group: "navigation", defaultBinding: "z M", title: "Collapse all folders" },
  { id: "nav.expandAll", group: "navigation", defaultBinding: "z R", title: "Expand all folders" },
  { id: "nav.jumpFolderUp", group: "navigation", defaultBinding: "z k", title: "Jump to folder above" },
  { id: "nav.jumpFolderDown", group: "navigation", defaultBinding: "z j", title: "Jump to folder below" },
  { id: "nav.pageUp", group: "navigation", defaultBinding: "Ctrl+K", title: "Scroll a page up" },
  { id: "nav.pageDown", group: "navigation", defaultBinding: "Ctrl+J", title: "Scroll a page down" },
  { id: "nav.isolateUp", group: "navigation", defaultBinding: "-", title: "Isolated mode: go up one level" },
